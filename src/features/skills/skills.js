...
const elements = {
  ...
  topTaskFilters: document.querySelector("#topTaskFilters"),
  ...
  heroBrowseLink: document.querySelector("#heroBrowseLink"),
  ...
  taskRailLabel: document.querySelector("#taskRailLabel"),
