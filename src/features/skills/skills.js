...
const designReferenceWebsites = [
  ...
  { name: "Reelfolio", domain: "reelfolio.io", url: "https://reelfolio.io/", group: "MOTION", previewType: "video", previewSrc: "./assets/skills/web/reelfolio-io-cover.mp4", previewImage: "./assets/skills/web/reelfolio-io-cover.png", previewRatio: "211 / 135", descriptionZh: "作品集网站的动效模板库，每张卡片悬停即预览 Rig、Folio、Comet、Rise 等开场与转场动画，适合研究作品集页面的展示动效。", descriptionEn: "A library of animated portfolio templates — hover any card to preview openings and transitions like Rig, Folio, Comet and Rise for studying portfolio showcase motion.", focusZh: "作品集动效 / 转场模板 / Hover 预览", focusEn: "Portfolio motion / transition templates / hover preview" },
