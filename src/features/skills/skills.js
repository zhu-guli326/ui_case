...
const designReferenceWebsites = [
  ...
  { name: "Cosmos", domain: "cosmos.so", url: "https://cosmos.so/", group: "DIRECTION", descriptionZh: "面向创意团队的视觉灵感空间，可按文字、颜色与视觉相似度搜索，并把参考整理成可检索的个人收藏。", descriptionEn: "A visual inspiration space for creative teams with text, color and similarity search plus connected personal collections.", focusZh: "视觉搜索 / 情绪板 / 灵感收藏", focusEn: "Visual search / moodboards / collections" },
  { name: "Refframe", domain: "refframe.com", url: "https://refframe.com/", group: "DIRECTION", descriptionZh: "按网站、页面区块、风格和行业组织参考，方便比较完整网页与 Hero、定价、页脚等局部结构。", descriptionEn: "Web references organized by site, section, style and industry for comparing full pages and reusable interface patterns.", focusZh: "网页参考 / 区块拆解 / 项目看板", focusEn: "Web references / section study / boards" },
  { name: "Best Designs on X", domain: "bestdesignsonx.com", url: "https://bestdesignsonx.com/", group: "DIRECTION", descriptionZh: "从 X 持续整理优秀视觉作品，覆盖 UI、品牌、Logo 等方向，适合快速追踪设计社区的新鲜表达。", descriptionEn: "Hourly hand-picked design inspiration from X across UI, branding, logos and other visual disciplines.", focusZh: "X 灵感 / 社区趋势 / 视觉扫描", focusEn: "X inspiration / community trends / visual scan" },
  { name: "The Internet Designs", domain: "theinternetdesigns.com", url: "https://theinternetdesigns.com/", group: "DIRECTION", descriptionZh: "汇集来自 X 与 Pinterest 的 UI 灵感，覆盖落地页、界面、动效、产品设计、品牌和插画。", descriptionEn: "Curated UI inspiration from X and Pinterest across landing pages, interfaces, motion, product, branding and illustration.", focusZh: "UI 灵感 / 社媒参考 / 多类型设计", focusEn: "UI inspiration / social references / mixed design" },
  { name: "Inspora", domain: "inspora.design", url: "https://inspora.design/", group: "DIRECTION", previewImage: "./assets/skills/web/inspora-design-cover.jpg", descriptionZh: "持续更新的视觉设计档案，按 Web、品牌、产品、动效、插画、3D 与印刷分类浏览近期作品。", descriptionEn: "A curated archive of recent work across web, branding, product, motion, illustration, 3D and print.", focusZh: "近期作品 / 多领域灵感 / 动效", focusEn: "Recent work / multidisciplinary inspiration / motion" },
  { name: "DesignBookmark", domain: "designbookmark.com", url: "https://designbookmark.com/", group: "DIRECTORY", descriptionZh: "收录 2,000+ 设计工具与网站，并按图标、字体、样机、Figma、模板、AI 和开发等类别集中检索。", descriptionEn: "A curated directory of 2,000+ design tools, sites, icons, fonts, mockups, templates, AI and development resources.", focusZh: "设计工具 / 素材目录 / 快速检索", focusEn: "Design tools / resource directory / search" },
  ...
  { name: "Beautiful UI", domain: "beautifului.dev", url: "https://beautifului.dev/", group: "COMPONENT", descriptionZh: "专为 AI 原生界面设计的基础组件，覆盖像素网格 Loading、可展开 Thinking、流式文本、Approval Card、Tool Chips 与实时 Task Rows。", descriptionEn: "Primitives for AI-native interfaces, including pixel-grid loading, expandable thinking, streaming text, approval cards, tool chips and live task rows.", focusZh: "AI 产品 / Agent 界面 / 状态设计", focusEn: "AI products / agent UI / states" },
  { name: "shadcn/ui", domain: "ui.shadcn.com", url: "https://ui.shadcn.com/", group: "COMPONENT", descriptionZh: "设计系统的开放地基：一套设计精良、可自定义、可扩展的组件与区块，从这里开始，再改成自己的产品语言。", descriptionEn: "An open foundation for design systems: beautifully designed, customizable and extensible components to make your own.", focusZh: "组件基础 / 设计系统 / React", focusEn: "Component foundation / design systems / React" },
...
function renderRepositoryToolbar() {
  ...
  if (heroUpdateCount) heroUpdateCount.textContent = isWebMode ? "+11" : "+8";
