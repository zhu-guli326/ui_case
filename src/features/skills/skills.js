...
const designReferenceWebsites = [
  ...
  { name: "Mobbin", domain: "mobbin.com", url: "https://mobbin.com/discover/apps/ios/latest", group: "PRODUCT", previewType: "video", previewSrc: "./assets/skills/web/mobbin-com.mp4", previewRatio: "320 / 167", descriptionZh: "按真实产品流程检索移动端与 Web 界面，适合拆解成熟 UX 模式。", descriptionEn: "Search real mobile and web product flows to study mature UX patterns.", focusZh: "App 流程 / UX 模式", focusEn: "App flows / UX patterns" },
