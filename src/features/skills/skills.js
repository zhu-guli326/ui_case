...
const designReferenceWebsites = [
  ...
  { name: "The Internet Designs", domain: "theinternetdesigns.com", url: "https://theinternetdesigns.com/", group: "DIRECTION", descriptionZh: "汇集来自 X 与 Pinterest 的设计灵感，可按 Interfaces、Landing page、Mobile apps、Dashboards、Interactions、Typography、3D、Brand 等分类筛选，每条作品附来源链接、配色色板与交互类型标注。", descriptionEn: "Design inspiration curated from X and Pinterest, filterable by interfaces, landing pages, mobile apps, dashboards, interactions, typography, 3D and brand design — each entry carries its source link, color palette and interaction type.", focusZh: "多类型 UI 灵感 / 分类筛选 / 来源与配色标注", focusEn: "Multi-type UI inspiration / category filters / source & palette notes" },
