...
export const libraryCopy = Object.freeze({
  zh: {
    ...
    heroTitle: "看看这些，\n再决定你想做成什么样。", heroIntro: "从真实案例开始找方向。看界面、试 Demo，再把喜欢的感觉带进你的设计。", heroAuthor: "作者主页", filterTitle: "分类筛选", filterHelpTitle: "先选一个方向？", filterHelpBody: "从场景开始看案例，再打开详情复制风格和提示词。", filterHelpAction: "查看案例细节", cases: "案例", styles: "风格", search: "搜索案例名称、使用场景或风格...", featured: "案例", searchResults: "搜索结果", startVisual: "从一个喜欢的界面开始。", searchTitle: "匹配的界面方向", count: (count) => `${count} 个案例`, empty: "没有找到匹配的案例。",
