export const vocabularyTranslations = {
  ...
  "vocabulary.overviewLabel": { zh: "词典概览", en: "Vocabulary overview" },
  "vocabulary.overviewTitle": { zh: "词典概览", en: "Vocabulary overview" },
  "vocabulary.overviewTerms": { zh: "UI 词条", en: "UI terms" },
  "vocabulary.overviewBrowseLabel": { zh: "浏览方式", en: "Browse" },
  "vocabulary.overviewBrowseValue": { zh: "搜索 + 筛选", en: "Search + filters" },
  "vocabulary.overviewPathLabel": { zh: "学习路径", en: "Learning path" },
  "vocabulary.overviewPathValue": { zh: "结构 → 形式 → 实现", en: "Structure → form → build" },
  "vocabulary.overviewPurposeLabel": { zh: "用途", en: "Purpose" },
  "vocabulary.overviewPurposeValue": { zh: "从需求到代码", en: "Request to code" },
  "vocabulary.directoryLabel": { zh: "UI 词条目录", en: "UI term directory" },
  "vocabulary.resultsListLabel": { zh: "UI 词条列表", en: "UI term list" },
  "vocabulary.footerNav": { zh: "页脚导航", en: "Footer navigation" },
  ...
  "vocabulary.navigationDeepTitle": { zh: "导航与发现不只有一种栏", en: "Navigation and discovery go beyond one bar" },
  "vocabulary.navigationEyebrow": { zh: "深入了解 / 导航模式", en: "DEEP DIVE / NAVIGATION PATTERNS" },
  "vocabulary.navigationDeepIntro": { zh: "从全局入口到搜索、筛选和长内容定位，这 14 种模式覆盖不同的信息范围、使用频率和设备场景。", en: "From global entry points to search, filtering, and long-form orientation, these 14 patterns cover different information scopes, frequencies, and devices." },
