...
const launcherTranslations = {
  ...
  "launcher.modeCreateTitle": { zh: "从零创建", en: "Create from scratch" },
  "launcher.modeCreateDetail": { zh: "产品、用户和页面", en: "Product, users, pages" },
  "launcher.modeRebuildTitle": { zh: "参考图还原", en: "Rebuild from reference" },
  "launcher.modeRebuildDetail": { zh: "页面、状态和交互", en: "Pages, states, interactions" },
  "launcher.modeImproveTitle": { zh: "优化现有页面", en: "Improve existing page" },
  "launcher.modeImproveDetail": { zh: "诊断并直接优化", en: "Diagnose and improve" },
  "launcher.modeExploreTitle": { zh: "探索现有项目", en: "Explore existing project" },
  ...
  "launcher.platformTitle": { zh: "目标平台", en: "Target platform" },
  "launcher.platformIntro": { zh: "平台会自动带入导航、字号、安全区和交互惯例。", en: "The platform auto-brings navigation, type scale, safe areas, and interaction conventions." },
  "launcher.platformGridLabel": { zh: "目标平台", en: "Target platform" },
  "launcher.platformIos": { zh: "iPhone · Apple 原生", en: "iPhone · Apple native" },
  "launcher.platformMac": { zh: "Mac · Apple 原生", en: "Mac · Apple native" },
  "launcher.platformHintTitle": { zh: "iOS 推荐：", en: "iOS recommended: " },
  "launcher.platformHintText": { zh: "Apple HIG + SF Pro + iOS 原生组件，并自动遵守 Safe Area。", en: "Apple HIG + SF Pro + iOS native components, with Safe Area respected automatically." },
  "launcher.colorThemeIntro": { zh: "选择组件与 Token 来源；系统摘要直接显示，不再打开第二层 Tab。", en: "Choose component and token sources; system summary shows inline without a second tab." },
  "launcher.themeGridLabel": { zh: "品牌设计规范", en: "Brand design system" },
  "launcher.dsWorkbenchTitle": { zh: "Design System 摘要", en: "Design System summary" },
  ...
  "launcher.summaryProgressLabel": { zh: "任务进度", en: "Task progress" },
  "launcher.promptPreviewTitle": { zh: "完整调用指令", en: "Full prompt" },
  "launcher.promptEditState": { zh: "随表单实时更新", en: "Updates live with the form" },
  "launcher.applyGenerated": { zh: "应用最新生成", en: "Apply latest" },
  "launcher.promptSyncNotice": { zh: "表单内容已更新；你的手动修改仍保留。", en: "The form updated; your manual edits are kept." },
  "launcher.promptOutputLabel": { zh: "可编辑的完整调用指令", en: "Editable full prompt" },
  "launcher.generatePrompt": { zh: "生成指令", en: "Generate prompt" },
  "launcher.copyPrompt": { zh: "复制指令", en: "Copy prompt" },
  "launcher.savePreset": { zh: "保存快照", en: "Save snapshot" },
  "launcher.pickerRefLabel": { zh: "参考案例", en: "Reference case" },
  "launcher.pickerTitle": { zh: "从案例库选择", en: "Choose from the library" },
  "launcher.pickerCloseLabel": { zh: "关闭案例选择器", en: "Close case picker" },
  "launcher.pickerHelp": { zh: "搜索、筛选并选择一个参考案例。按 Escape 可关闭。", en: "Search, filter, and pick a reference case. Press Escape to close." },
  "launcher.pickerSearchLabel": { zh: "搜索案例", en: "Search cases" },
  "launcher.pickerSearchPlaceholder": { zh: "名称、风格或标签", en: "Name, style, or tag" },
  "launcher.pickerStyleFilter": { zh: "按风格筛选", en: "Filter by style" },
  "launcher.pickerCategoryFilter": { zh: "按类型筛选", en: "Filter by category" },
  "launcher.pickerEmpty": { zh: "没有符合当前条件的案例。", en: "No cases match the current filters." },
  "launcher.assistantToggle": { zh: "任务助手", en: "Task assistant" },
  "launcher.assistantLabel": { zh: "工作区助手", en: "Workspace assistant" },
  "launcher.assistantTitle": { zh: "下一步建议", en: "Next steps" },
  "launcher.assistantCloseLabel": { zh: "关闭任务助手", en: "Close task assistant" },
};

window.image2I18n?.addTranslations?.(launcherTranslations);
