...
const definitions = [
  ...
  brandTheme({
    ...
    colors: { canvas:"#f7f7f4", surface:"#ffffff", ink:"#26251e", muted:"#706d64", accent:"#f54e00", actionAccent:"#d04200", accentSoft:"#fff0e8", success:"#1f8a65", warning:"#c08532", danger:"#cf2d56", border:"#e6e5e0", onAccent:"#ffffff" },
  ...
  brandTheme({
    ...
    colors: { canvas:"#ffffff", surface:"#f7f7f7", ink:"#0a0b0d", muted:"#6f747a", accent:"#0052ff", actionAccent:"#003ecc", accentSoft:"#eef3ff", success:"#05b169", warning:"#f4b000", danger:"#cf202f", border:"#dee1e6", onAccent:"#ffffff" },
